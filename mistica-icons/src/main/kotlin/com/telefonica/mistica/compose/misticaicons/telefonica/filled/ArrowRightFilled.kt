    ...
    get() {
        ...
        _arrowRightFilled = Builder(name = "ArrowRightFilled", defaultWidth = 24.0.dp, defaultHeight
            ...
            path(fill = SolidColor(Color(0xFF313235)), stroke = null, strokeLineWidth = 0.0f,
                ...
                moveTo(11.894f, 21.69f)
                curveToRelative(-0.152f, 0.0f, -0.3f, -0.029f, -0.44f, -0.085f)
                curveToRelative(-0.434f, -0.176f, -0.7f, -0.602f, -0.695f, -1.106f)
                lineToRelative(-0.003f, -3.65f)
                curveToRelative(-0.01f, -0.02f, -0.022f, -0.04f, -0.039f, -0.056f)
                lineToRelative(-6.882f, -0.02f)
                curveToRelative(-0.617f, 0.009f, -1.07f, -0.146f, -1.384f, -0.468f)
                curveToRelative(-0.314f, -0.322f, -0.46f, -0.776f, -0.443f, -1.392f)
                verticalLineToRelative(-6.04f)
                curveTo(2.0f, 8.454f, 2.04f, 7.85f, 2.445f, 7.43f)
                curveToRelative(0.407f, -0.42f, 1.009f, -0.48f, 1.426f, -0.488f)
                horizontalLineToRelative(0.009f)
                lineToRelative(6.711f, 0.003f)
                arcToRelative(0.453f, 0.453f, 0.0f, false, false, 0.157f, -0.053f)
                lineToRelative(-0.009f, -3.56f)
                ...
                curveToRelative(0.087f, 0.084f, 0.336f, 0.33f, 0.334f, 0.69f)
                arcToRelative(0.82f, 0.82f, 0.0f, false, true, -0.275f, 0.593f)
                lineToRelative(-8.476f, 8.706f)
