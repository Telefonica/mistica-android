    ...
    get() {
        ...
        _payInvoiceRegular = Builder(name = "PayInvoiceRegular", defaultWidth = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF313235)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(18.574f, 20.574f)
                lineTo(6.43f, 20.574f)
                lineTo(6.43f, 4.144f)
                curveToRelative(0.0f, -0.393f, 0.32f, -0.713f, 0.713f, -0.713f)
                lineTo(17.86f, 3.431f)
                curveToRelative(0.394f, 0.0f, 0.714f, 0.32f, 0.714f, 0.713f)
                verticalLineToRelative(16.43f)
                close()
                moveTo(16.969f, 17.36f)
                ...
                curveToRelative(0.293f, 0.0f, 0.535f, 0.238f, 0.535f, 0.535f)
                close()
                moveTo(16.969f, 13.79f)
                arcToRelative(0.533f, 0.533f, 0.0f, false, true, -0.535f, 0.535f)
                ...
                arcToRelative(2.682f, 2.682f, 0.0f, false, true, -2.625f, -2.144f)
                horizontalLineToRelative(-0.365f)
                arcToRelative(0.53f, 0.53f, 0.0f, false, true, -0.535f, -0.535f)
                close()
            }
        }
        .build()
