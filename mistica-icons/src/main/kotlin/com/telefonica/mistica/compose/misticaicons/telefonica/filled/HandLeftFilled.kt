...
public val FilledGroup.HandLeftFilled: ImageVector
    get() {
        if (_handLeftFilled != null) {
            return _handLeftFilled!!
        }
        _handLeftFilled = Builder(name = "HandLeftFilled", defaultWidth = 24.0.dp, defaultHeight =
                24.0.dp, viewportWidth = 24.0f, viewportHeight = 24.0f).apply {
            path(fill = SolidColor(Color(0xFF313235)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = NonZero) {
                moveTo(9.62f, 18.164f)
                curveToRelative(0.0f, -0.283f, 0.039f, -0.54f, 0.117f, -0.773f)
                curveToRelative(-0.857f, -0.238f, -1.367f, -0.942f, -1.367f, -1.95f)
                curveToRelative(0.0f, -0.283f, 0.042f, -0.543f, 0.118f, -0.776f)
                curveToRelative(-0.849f, -0.24f, -1.353f, -0.941f, -1.353f, -1.944f)
                ...
                arcToRelative(1.927f, 1.927f, 0.0f, false, true, -0.43f, -1.207f)
...
private var _handLeftFilled: ImageVector? = null
