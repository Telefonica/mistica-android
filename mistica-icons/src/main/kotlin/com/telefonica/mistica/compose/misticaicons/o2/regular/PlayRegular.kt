    ...
    get() {
        ...
        _playRegular = Builder(name = "PlayRegular", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF313235)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(6.091f, 3.42f)
                arcToRelative(0.85f, 0.85f, 0.0f, false, false, -0.404f, 0.108f)
                curveToRelative(-0.102f, 0.072f, -0.336f, 0.252f, -0.336f, 0.536f)
                verticalLineToRelative(15.9f)
                curveToRelative(0.0f, 0.252f, 0.17f, 0.392f, 0.268f, 0.464f)
                curveToRelative(0.204f, 0.108f, 0.506f, 0.18f, 0.774f, 0.036f)
                lineToRelative(13.112f, -8.04f)
                arcToRelative(0.88f, 0.88f, 0.0f, false, false, 0.17f, -0.5f)
                arcToRelative(0.639f, 0.639f, 0.0f, false, false, -0.302f, -0.5f)
                lineTo(6.393f, 3.492f)
                arcToRelative(0.946f, 0.946f, 0.0f, false, false, -0.302f, -0.072f)
                close()
            }
        }
        .build()
