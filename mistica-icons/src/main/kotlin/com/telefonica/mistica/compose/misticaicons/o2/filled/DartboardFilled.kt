...
public val FilledGroup.DartboardFilled: ImageVector
    get() {
        if (_dartboardFilled != null) {
            return _dartboardFilled!!
        }
        _dartboardFilled = Builder(name = "DartboardFilled", defaultWidth = 24.0.dp, defaultHeight =
                24.0.dp, viewportWidth = 24.0f, viewportHeight = 24.0f).apply {
            path(fill = SolidColor(Color(0xFF313235)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = NonZero) {
                moveTo(16.096f, 9.984f)
                arcToRelative(7.678f, 7.678f, 0.0f, false, true, 1.32f, 4.307f)
                curveToRelative(0.0f, 4.252f, -3.458f, 7.709f, -7.708f, 7.709f)
                curveTo(5.457f, 22.0f, 2.0f, 18.543f, 2.0f, 14.291f)
                curveToRelative(0.0f, -4.251f, 3.457f, -7.708f, 7.708f, -7.708f)
                curveToRelative(1.597f, 0.0f, 3.076f, 0.488f, 4.307f, 1.32f)
                lineTo(11.6f, 10.317f)
...
private var _dartboardFilled: ImageVector? = null
