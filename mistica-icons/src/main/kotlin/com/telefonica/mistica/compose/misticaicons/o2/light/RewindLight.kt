    ...
    get() {
        ...
        _rewindLight = Builder(name = "RewindLight", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF313235)), stroke = null, strokeLineWidth = 0.0f,
                ...
                arcToRelative(0.365f, 0.365f, 0.0f, false, false, 0.251f, -0.105f)
                close()
                moveTo(10.468f, 16.895f)
                arcToRelative(0.35f, 0.35f, 0.0f, false, false, 0.0f, -0.503f)
                lineToRelative(-4.387f, -4.387f)
                lineToRelative(4.388f, -4.388f)
                arcToRelative(0.35f, 0.35f, 0.0f, false, false, 0.0f, -0.503f)
                arcToRelative(0.354f, 0.354f, 0.0f, false, false, -0.503f, 0.0f)
                lineTo(5.323f, 11.75f)
                arcToRelative(0.35f, 0.35f, 0.0f, false, false, 0.0f, 0.502f)
                lineToRelative(4.643f, 4.644f)
                curveToRelative(0.069f, 0.068f, 0.16f, 0.105f, 0.252f, 0.105f)
                arcToRelative(0.365f, 0.365f, 0.0f, false, false, 0.25f, -0.105f)
                close()
            }
        }
        .build()
