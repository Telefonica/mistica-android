...
public val LightGroup.ArrowBackLight: ImageVector
    get() {
        if (_arrowBackLight != null) {
            return _arrowBackLight!!
        }
        _arrowBackLight = Builder(name = "ArrowBackLight", defaultWidth = 24.0.dp, defaultHeight =
                24.0.dp, viewportWidth = 24.0f, viewportHeight = 24.0f).apply {
            path(fill = SolidColor(Color(0xFF313235)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = NonZero) {
                moveTo(19.529f, 11.62f)
                ...
                arcToRelative(0.472f, 0.472f, 0.0f, false, false, -0.471f, -0.469f)
...
private var _arrowBackLight: ImageVector? = null
