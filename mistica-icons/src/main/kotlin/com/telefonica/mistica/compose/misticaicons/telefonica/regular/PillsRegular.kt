...
public val RegularGroup.PillsRegular: ImageVector
    get() {
        if (_pillsRegular != null) {
            return _pillsRegular!!
        }
        _pillsRegular = Builder(name = "PillsRegular", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF313235)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(10.547f, 18.246f)
                curveToRelative(-1.902f, 1.788f, -3.753f, 1.723f, -5.667f, -0.19f)
                curveToRelative(-1.972f, -1.975f, -1.972f, -3.896f, -0.005f, -5.868f)
                lineToRelative(0.157f, -0.163f)
                curveToRelative(0.084f, -0.087f, 0.165f, -0.176f, 0.285f, -0.283f)
                lineToRelative(2.636f, -2.641f)
                curveToRelative(0.194f, 1.126f, 0.908f, 2.32f, 2.157f, 3.574f)
                curveToRelative(0.241f, 0.238f, 0.476f, 0.457f, 0.706f, 0.656f)
                curveToRelative(-0.31f, 0.784f, -0.468f, 1.703f, -0.468f, 2.753f)
                curveToRelative(0.0f, 0.773f, 0.087f, 1.47f, 0.255f, 2.1f)
                arcToRelative(0.255f, 0.255f, 0.0f, false, true, -0.056f, 0.062f)
                close()
                moveTo(11.746f, 5.296f)
                curveToRelative(0.078f, -0.089f, 0.165f, -0.17f, 0.252f, -0.254f)
                ...
                curveToRelative(0.003f, -0.014f, 0.0f, -0.028f, 0.003f, -0.042f)
                lineToRelative(2.515f, -2.521f)
                close()
                moveTo(20.566f, 15.462f)
                ...
                curveToRelative(-0.117f, 0.112f, -0.23f, 0.221f, -0.302f, 0.308f)
...
private var _pillsRegular: ImageVector? = null
