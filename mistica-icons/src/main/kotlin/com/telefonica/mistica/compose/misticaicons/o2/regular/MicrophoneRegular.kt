    ...
    get() {
        ...
        _microphoneRegular = Builder(name = "MicrophoneRegular", defaultWidth = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF313235)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(10.485f, 14.04f)
                curveToRelative(0.0f, 1.162f, 0.869f, 2.039f, 2.02f, 2.039f)
                curveToRelative(1.15f, 0.0f, 2.02f, -0.877f, 2.02f, -2.04f)
                verticalLineToRelative(-8.52f)
                curveToRelative(0.0f, -1.161f, -0.87f, -2.039f, -2.02f, -2.039f)
                curveToRelative(-1.151f, 0.0f, -2.02f, 0.878f, -2.02f, 2.04f)
                verticalLineToRelative(8.52f)
                close()
            }
        }
