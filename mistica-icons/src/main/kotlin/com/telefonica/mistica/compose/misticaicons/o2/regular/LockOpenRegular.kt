    ...
    get() {
        ...
        _lockOpenRegular = Builder(name = "LockOpenRegular", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF313235)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(18.638f, 19.853f)
                curveToRelative(0.0f, 0.396f, -0.31f, 0.716f, -0.684f, 0.716f)
                lineTo(7.046f, 20.569f)
                curveToRelative(-0.378f, 0.0f, -0.683f, -0.324f, -0.683f, -0.716f)
                lineTo(6.363f, 12.0f)
                curveToRelative(0.0f, -0.396f, 0.309f, -0.716f, 0.683f, -0.716f)
                horizontalLineToRelative(10.908f)
                curveToRelative(0.378f, 0.0f, 0.683f, 0.324f, 0.683f, 0.716f)
                verticalLineToRelative(7.853f)
                close()
            }
        }
        .build()
