    ...
    get() {
        ...
        _checkedLight = Builder(name = "CheckedLight", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF313235)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(17.907f, 8.1f)
                arcToRelative(0.336f, 0.336f, 0.0f, false, true, 0.0f, 0.466f)
                lineTo(10.928f, 16.0f)
                lineToRelative(-3.834f, -4.267f)
                arcToRelative(0.336f, 0.336f, 0.0f, false, true, 0.0f, -0.467f)
                arcToRelative(0.292f, 0.292f, 0.0f, false, true, 0.44f, 0.0f)
                lineToRelative(3.394f, 3.732f)
                lineTo(17.466f, 8.1f)
                arcToRelative(0.292f, 0.292f, 0.0f, false, true, 0.44f, 0.0f)
                close()
            }
