...
object O2ClassicBrand : Brand {
    ...
    override val lightColors = MisticaColors(
        ...
        initialsIconBackground = O2ClassicPaletteColor.o2_classic_color_blue_10,
        initialsIconForeground = O2ClassicPaletteColor.o2_classic_color_blue,
    ...
    override val darkColors = lightColors.copy(
        ...
        tagBackgroundActive = O2ClassicPaletteColor.o2_classic_color_darkModeGrey,
        tagBackgroundError = O2ClassicPaletteColor.o2_classic_color_darkModeGrey,
        tagBackgroundInactive = O2ClassicPaletteColor.o2_classic_color_darkModeGrey,
        tagBackgroundPromo = O2ClassicPaletteColor.o2_classic_color_darkModeGrey,
        tagBackgroundSuccess = O2ClassicPaletteColor.o2_classic_color_darkModeGrey,
        tagBackgroundWarning = O2ClassicPaletteColor.o2_classic_color_darkModeGrey,
