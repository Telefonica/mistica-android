...
object VivoBrand : Brand {
    ...
    override val darkColors = lightColors.copy(
        ...
        tagBackgroundActive = VivoPaletteColor.vivo_color_darkModeGrey,
        tagBackgroundError = VivoPaletteColor.vivo_color_darkModeGrey,
        tagBackgroundInactive = VivoPaletteColor.vivo_color_darkModeGrey,
        tagBackgroundPromo = VivoPaletteColor.vivo_color_darkModeGrey,
        tagBackgroundSuccess = VivoPaletteColor.vivo_color_darkModeGrey,
        tagBackgroundWarning = VivoPaletteColor.vivo_color_darkModeGrey,
