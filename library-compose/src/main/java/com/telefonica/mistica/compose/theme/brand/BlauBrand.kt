...
object BlauBrand : Brand {
    ...
    override val darkColors = lightColors.copy(
        ...
        tagBackgroundActive = BlauPaletteColor.blau_color_darkModeGrey,
        tagBackgroundError = BlauPaletteColor.blau_color_darkModeGrey,
        tagBackgroundInactive = BlauPaletteColor.blau_color_darkModeGrey,
        tagBackgroundPromo = BlauPaletteColor.blau_color_darkModeGrey,
        tagBackgroundSuccess = BlauPaletteColor.blau_color_darkModeGrey,
        tagBackgroundWarning = BlauPaletteColor.blau_color_darkModeGrey,
        textAppBar = BlauPaletteColor.blau_color_grey_5,
