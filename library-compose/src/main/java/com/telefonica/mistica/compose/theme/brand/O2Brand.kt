...
object O2Brand : Brand {
    ...
    override val darkColors = lightColors.copy(
        ...
        tagBackgroundActive = O2PaletteColor.o2_color_darkModeGrey,
        tagBackgroundError = O2PaletteColor.o2_color_darkModeGrey,
        tagBackgroundInactive = O2PaletteColor.o2_color_darkModeGrey,
        tagBackgroundPromo = O2PaletteColor.o2_color_darkModeGrey,
        tagBackgroundSuccess = O2PaletteColor.o2_color_darkModeGrey,
        tagBackgroundWarning = O2PaletteColor.o2_color_darkModeGrey,
