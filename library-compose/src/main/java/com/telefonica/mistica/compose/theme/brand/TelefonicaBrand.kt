...
object TelefonicaBrand : Brand {
    ...
    override val lightColors = MisticaColors(
        ...
        initialsIconBackground = TelefonicaPaletteColor.telefonica_color_darkModeGrey,
        initialsIconForeground = TelefonicaPaletteColor.telefonica_color_blue_30,
    ...
    override val darkColors = MisticaColors(
        ...
        success = TelefonicaPaletteColor.telefonica_color_turquoise,
        tagBackgroundActive = TelefonicaPaletteColor.telefonica_color_darkModeGrey,
        tagBackgroundError = TelefonicaPaletteColor.telefonica_color_darkModeGrey,
        tagBackgroundInactive = TelefonicaPaletteColor.telefonica_color_darkModeGrey,
        tagBackgroundPromo = TelefonicaPaletteColor.telefonica_color_darkModeGrey,
        tagBackgroundSuccess = TelefonicaPaletteColor.telefonica_color_darkModeGrey,
        tagBackgroundWarning = TelefonicaPaletteColor.telefonica_color_darkModeGrey,
