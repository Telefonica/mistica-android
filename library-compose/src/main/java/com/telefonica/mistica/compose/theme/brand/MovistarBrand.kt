...
object MovistarBrand : Brand {
    ...
    override val darkColors =
        lightColors.copy(
            ...
            tagBackgroundActive = MovistarPaletteColor.movistar_color_darkModeGrey,
            tagBackgroundError = MovistarPaletteColor.movistar_color_darkModeGrey,
            tagBackgroundInactive = MovistarPaletteColor.movistar_color_darkModeGrey,
            tagBackgroundPromo = MovistarPaletteColor.movistar_color_darkModeGrey,
            tagBackgroundSuccess = MovistarPaletteColor.movistar_color_darkModeGrey,
            tagBackgroundWarning = MovistarPaletteColor.movistar_color_darkModeGrey,
