...
class GenerateBrandFontWeights {
    ...
    operator fun invoke(tokens: TokensDTO, brandName: String) {
        ...
        val textObject = TypeSpec.objectBuilder("${brandName.capitalizeString()}BrandFontWeights")
            .addProperties(properties)
            .build()

        val file = FileSpec.builder("com.telefonica.mistica.compose.theme.brand", "${brandName.capitalizeString()}BrandFontWeightsAutogenerated")
