...
import com.telefonica.mistica.tokens.TokensGenerator.Companion.AUTOGENERATED_COMMENT_FOR_VIVO_NEW
...
import com.telefonica.mistica.tokens.TokensGenerator.Companion.VIVO_NEW
...
class GenerateXMLFiles(
    ...
    private fun generateLightThemesFiles(tokens: TokensDTO, brandName: String) {
        val lightThemesXml = xml("resources", "utf-8", XmlVersion.V10) {
            ...
            if (brandName == VIVO_NEW) { //TODO: ANDROID-13833 Remove this when VIVO_NEW is main style.
                comment(AUTOGENERATED_COMMENT_FOR_VIVO_NEW)
            }
