...
public object BlauBrandColors {
  public val lightColors: MisticaColors = MisticaColors().apply {
      ...
      buttonPrimaryBackgroundSelected = BlauPaletteColor.blau_color_blauBlueSecondary60
      buttonPrimaryBackgroundHover = BlauPaletteColor.blau_color_blauBlueSecondary60
      buttonPrimaryBackgroundInverseSelected = BlauPaletteColor.blau_color_blauBluePrimary30
      buttonSecondaryBorder = BlauPaletteColor.blau_color_blauBlueSecondary
      buttonSecondaryBorderSelected = BlauPaletteColor.blau_color_blauBlueSecondary60
      ...
      buttonSecondaryBackgroundSelected = BlauPaletteColor.blau_color_blauBlueSecondary10
      buttonSecondaryBorderInverseSelected = BlauPaletteColor.blau_color_white
      buttonSecondaryBackgroundInverseHover = BlauPaletteColor.blau_color_white_20_alpha
      buttonSecondaryBackgroundInverseSelected = BlauPaletteColor.blau_color_white_20_alpha
      ...
      textButtonPrimaryInverseSelected = BlauPaletteColor.blau_color_blauBlueSecondary60
      textButtonSecondary = BlauPaletteColor.blau_color_blauBlueSecondary
      textButtonSecondarySelected = BlauPaletteColor.blau_color_blauBlueSecondary60
  ...
  public val darkColors: MisticaColors = MisticaColors().apply {
      ...
      buttonPrimaryBackgroundSelected = BlauPaletteColor.blau_color_blauBlueSecondary60
      buttonPrimaryBackgroundHover = BlauPaletteColor.blau_color_blauBlueSecondary60
      buttonPrimaryBackgroundInverseSelected = BlauPaletteColor.blau_color_blauBlueSecondary60
      buttonSecondaryBorder = BlauPaletteColor.blau_color_white
      buttonSecondaryBorderSelected = BlauPaletteColor.blau_color_white
      buttonSecondaryBackgroundHover = BlauPaletteColor.blau_color_white_15_alpha
      buttonSecondaryBackgroundSelected = BlauPaletteColor.blau_color_white_15_alpha
      buttonSecondaryBorderInverse = BlauPaletteColor.blau_color_white
      buttonSecondaryBorderInverseSelected = BlauPaletteColor.blau_color_white
      buttonSecondaryBackgroundInverseHover = BlauPaletteColor.blau_color_white_15_alpha
      buttonSecondaryBackgroundInverseSelected = BlauPaletteColor.blau_color_white_15_alpha
      textButtonPrimary = BlauPaletteColor.blau_color_grey2
      textButtonPrimaryInverse = BlauPaletteColor.blau_color_grey2
      textButtonPrimaryInverseSelected = BlauPaletteColor.blau_color_grey2
      textButtonSecondary = BlauPaletteColor.blau_color_grey2
      textButtonSecondarySelected = BlauPaletteColor.blau_color_grey2
      textButtonSecondaryInverse = BlauPaletteColor.blau_color_grey2
      textButtonSecondaryInverseSelected = BlauPaletteColor.blau_color_grey2
